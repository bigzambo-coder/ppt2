...
const LECTURE: DocTypeSpec = {
  ...
  designAffinity: ["public_data", "school_fresh", "youth_pop", "ocean_depths", "arctic_frost", "botanical_garden"],
  ...
  sections: [
    ...
    { id: "agenda", title: "진행 순서", purpose: "전체 시간을 블록으로 나눈 진행표. 각 블록의 소요 시간을 분 단위로 명시한다.", layouts: ["timeline", "table"], weight: 1 },
...
const WORKSHOP: DocTypeSpec = {
  ...
  fields: [...COMMON_CORE, ...TIME_FIELDS, ...PRESENTER_FIELDS, ...DETAIL_FIELDS],
  designAffinity: ["youth_pop", "small_business_bright", "school_fresh", "sunset_boulevard", "botanical_garden", "golden_hour"],
  ...
  sections: [
    ...
    { id: "agenda", title: "진행 순서", purpose: "시간 블록별 진행표. 설명·시연·실습·공유에 각각 몇 분을 쓰는지 명시한다.", layouts: ["timeline", "table"], weight: 1 },
